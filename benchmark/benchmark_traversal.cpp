...
BENCHMARK(benchmark_sum_inner_to_outer)->Args({10000, 1000}); // 40000 KB -> DRAM
...
BENCHMARK(benchmark_sum_outer_to_inner)->Args({10000, 1000}); // 40000 KB -> DRAM
...
BENCHMARK(benchmark_sum_outer_to_inner)->Args({ 1000, 1024}); //  4000 KB -> DRAM
BENCHMARK(benchmark_sum_outer_to_inner)->Args({10000, 1024}); // 40000 KB -> DRAM
